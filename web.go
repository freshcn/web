...
// SetSecureCookie 设置安全的cookie,在使用之前需要对config中设置一个cookie的加密密钥
...
// Handler Adds a custom handler. Only for webserver mode. Will have no effect when running as FCGI or SCGI^.
